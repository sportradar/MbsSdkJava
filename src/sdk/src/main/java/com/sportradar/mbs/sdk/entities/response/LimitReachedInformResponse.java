...
/**
 * Represents a response for a limit reached inform request.
 */
public class LimitReachedInformResponse extends ContentResponse {
    ...
    /**
     * Creates a new builder instance for constructing a {@code LimitReachedInformResponse}.
     *
    ...
    /**
     * Builder class for {@code LimitReachedInformResponse} to facilitate object creation.
     */
    public static class Builder {

        /**
         * Instance of {@code LimitReachedInformResponse} being built.
         */
        ...
        /**
         * Builds and returns the {@code LimitReachedInformResponse} instance.
         *
         * @return the constructed {@code LimitReachedInformResponse} instance
         */
