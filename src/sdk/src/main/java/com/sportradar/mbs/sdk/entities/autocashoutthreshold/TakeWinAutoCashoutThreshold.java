...
public class TakeWinAutoCashoutThreshold extends AutoCashoutThreshold {
    ...
    public static class Builder {
        ...
        private final TakeWinAutoCashoutThreshold instance = new TakeWinAutoCashoutThreshold();

        private Builder() {
        }

        public TakeWinAutoCashoutThreshold build() {
