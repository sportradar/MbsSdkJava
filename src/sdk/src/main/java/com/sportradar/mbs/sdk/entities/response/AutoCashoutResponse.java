...
public class AutoCashoutResponse extends ContentResponse {
    ...
    public static class Builder {
        ...
        private final AutoCashoutResponse instance = new AutoCashoutResponse();

        private Builder() {
        }

        public AutoCashoutResponse build() {
