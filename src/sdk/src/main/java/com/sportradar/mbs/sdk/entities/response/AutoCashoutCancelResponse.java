...
public class AutoCashoutCancelResponse extends ContentResponse {
    ...
    public static class Builder {
        ...
        private final AutoCashoutCancelResponse instance = new AutoCashoutCancelResponse();

        private Builder() {
        }

        public AutoCashoutCancelResponse build() {
