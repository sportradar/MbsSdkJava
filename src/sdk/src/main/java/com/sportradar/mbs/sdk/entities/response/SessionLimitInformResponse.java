...
/**
 * Represents a response for a session limit inform request.
 */
public class SessionLimitInformResponse extends ContentResponse {
  ...
  /**
   * Creates a new builder instance for constructing a {@code SessionLimitInformResponse}.
   *
  ...
  /**
   * Builder class for {@code SessionLimitInformResponse} to facilitate object creation.
   */
  public static class Builder {

    /**
     * Instance of {@code SessionLimitInformResponse} being built.
     */
    ...
    /**
     * Builds and returns the {@code SessionLimitInformResponse} instance.
     *
     * @return the constructed {@code SessionLimitInformResponse} instance
     */
